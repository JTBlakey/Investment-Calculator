...
def LISA():
    try:
        ...
        final_amount = calculate_investment(initial, years, rate, contribution, compound, contribute_at_beginning)
        print(f"Final LISA investment value after {years} years: ${final_amount}")
    except ValueError:
        print("Invalid input. Please enter numbers correctly.")

choice = input("Enter 1 for ANY or 2 for LISA: ").strip()
...
if choice == "1":
    ...
    print("Invalid selection.")#INVESTMENT program
#joel blake
